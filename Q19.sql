...
Question: For each maker having models in Laptop table, find out the average screen size of the laptops produced by it. 
...
SELECT maker,
       avg(screen)
FROM laptop A
INNER JOIN product AS b ON a.model = b.model
GROUP BY maker
