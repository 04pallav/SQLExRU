...
Question: Find the all ship names consisting of three or more words (for example King George V).
Take into account that words in ship names are separated by single spaces and there are no leading and trailing spaces.
*/
